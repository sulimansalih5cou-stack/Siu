...
// ** يتم وضعها في البداية لضمان تنفيذها فور تحميل السكربت على جميع الصفحات **
// ============================================================
(function() {
    // 1. منع تحديد النص باستخدام CSS عبر إضافة نمط عام لـ <body>
    ...
    style.textContent = `
        body {
            ...
            -webkit-touch-callout: none; /* منع قائمة النسخ في iOS عند الضغط المطول */
        }
    `;
    ...
    // 3. منع ظهور قائمة النسخ عند الضغط المطول على شاشات اللمس (Android/iOS)
    document.addEventListener('touchstart', function(e) {
        // نمنع الحدث الافتراضي لبداية اللمس، وهو تفعيل وضع التحديد والنسخ.
        e.preventDefault();
    }, { passive: false }); // { passive: false } ضرورية لضمان عمل preventDefault

    // 4. منع اختصارات لوحة المفاتيح الشائعة (Ctrl/Cmd + C, U, A)
    document.addEventListener('keydown', function(e) {
        if (e.ctrlKey || e.metaKey) { // Ctrl for Windows/Linux, Cmd for macOS
            // C: نسخ، U: مصدر الصفحة، A: تحديد الكل
